...
if(file_exists($inipath)){
	...
	echo "<h2>The configuration file (".$inipath.") does not exist!</h2>";
	die();
}
	...
	echo "<div class=\"infofield\">";
		if ($_SESSION["plot_start"] == "True"){ // Prüfen ob der Plotdienst eingeschaltet ist
			if(file_exists("".$document_root."/tmp/temperaturkurve.png")){ //Überprüfen ob eine Plotgrafik existiert
				...
				echo "<h2>Current plot image is saved...</h2>";
			}else{ 
				echo "<h2>Plot image is unavilable...</h2>";
			}
		}
		...
		echo "  <head> <meta http-equiv=\"refresh\" content=\"1;URL='../index.php'\"> </head> <body> <h2>New log file created...</h2></body>";	
...
//-------------------------------------------------------------------------------------------------------------------------------------	
	...
	echo "<div class=\"infofield\">";
	 echo "  <head> <meta http-equiv=\"refresh\" content=\"1;URL='../index.php'\"> </head> <body> <p><h2>No new log file created...</h2></p></body>";
	echo "</div>";
}else{
...
<div id="new_log_file_site">
	<h1>CREATE NEW LOG FILE</h1>
	<form action="new_log_file.php" method="post" >
		<br>
		<p align="center"><b>Are you sure you want to create a new logfile?</b></p>			
