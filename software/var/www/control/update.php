<?php
	...
	if((file_exists('../tmp/update')) OR (file_exists('../tmp/nextionupdatelog'))){
		...
		echo "  <head> <meta http-equiv=\"refresh\" content=\"1;URL='../index.php'\"> </head> <body> <h2>The update has already been started...</h2></body>";
		echo '</div>';
		exit;
	}
	if ((!isset($_SESSION["newversion"])) and (!isset($_SESSION["nextionupdate"]))){
		echo '<div id="info_site">';
		echo "  <head> <meta http-equiv=\"refresh\" content=\"1;URL='../index.php'\"> </head> <body> <h2>No new updates are available...</h2></body>";
		echo '</div>';
		exit;
	}
?>
